...
typedef struct _SpawnCallbackMessage {
    ...
    int32_t y;
    int32_t health;
/* @@protoc_insertion_point(struct:SpawnCallbackMessage) */
} SpawnCallbackMessage;
...
#define SpawnCallbackMessage_init_default        {0, 0, 0, 0}
#define GameDataMessage_init_default             {0, 0, {{NULL}, NULL}, {{NULL}, NULL}}
#define SDL_Rect_init_default                    {0, 0, 0, 0}
#define PlayerBase_init_default                  {-1, "", 100, 30, 0, 0, mainPlayer_init_default_realPos}
...
#define UnionMessage_init_default                {ConnectionMessage_init_default, ConnectionCallbackMessage_init_default, BulletMessage_init_default, PlayerBase_init_default, SpawnMessage_init_default, SpawnCallbackMessage_init_default, GameDataMessage_init_default, QuitMessage_init_default}
...
#define SpawnCallbackMessage_init_zero           {0, 0, 0, 0}
...
#define SpawnCallbackMessage_id_tag              1
#define SpawnCallbackMessage_x_tag               2
#define SpawnCallbackMessage_y_tag               3
#define SpawnCallbackMessage_health_tag          4
...
#define PlayerBase_name_tag                      2
#define PlayerBase_health_tag                    3
#define PlayerBase_ammo_tag                      4
#define PlayerBase_state_tag                     5
#define PlayerBase_orientation_tag               6
#define PlayerBase_pos_tag                       7
#define Player_playerBase_tag                    1
#define Player_relativePos_tag                   2
#define Player_lastAnim_tag                      3
#define Player_sprite_tag                        4
#define Player_walkAnimationStep_tag             5
#define Player_deathAnimationStep_tag            6
#define Player_name_tag                          7
...
extern const pb_field_t SpawnCallbackMessage_fields[5];
extern const pb_field_t GameDataMessage_fields[5];
extern const pb_field_t SDL_Rect_fields[5];
extern const pb_field_t PlayerBase_fields[8];
extern const pb_field_t Player_fields[8];
...
#define SpawnCallbackMessage_size                44
/* GameDataMessage_size depends on runtime parameters */
#define SDL_Rect_size                            44
#define PlayerBase_size                          119
#define Player_size                              264
#define BulletMessage_size                       125
#define UnionMessage_size                        (504 + GameDataMessage_size)
