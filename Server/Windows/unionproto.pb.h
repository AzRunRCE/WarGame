...
extern "C" {
	...
	typedef struct _UnionMessage {
		bool has_newBullet;
		BulletMessage newBullet;
		bool has_connectionResult;
		ConnectionCallbackMessage connectionResult;
		bool has_connectionMessage;
...
#define UnionMessage_newBullet_tag               1
#define UnionMessage_connectionResult_tag        2
#define UnionMessage_connectionMessage_tag       3
